  ...
  return (
    <div className='m-[1rem] h-[95vh] w-[20vw] rounded-lg side-bar-css'>
      <div className='h-[5rem] flex items-center justify-center border-b border-[rgba(255,255,255,0.5)]'>
        <img src='/Skils-Black.svg' className='h-[3rem] transition-all duration-300 hover:shadow-[3px_3px_0px_0px_rgba(255,255,255)]' />
      </div>
      <div className='w-full flex flex-col gap-[1rem] px-[1rem] mt-[1rem]'>
        {
          options.map((option) => {
            ...
            }} className={`${option.selected && 'bg-[#389df0] shadow-[0_8px_20px_rgb(255,255,255,0.12)]'} px-[1rem] transition-all cursor-pointer ${!option.selected && 'hover:bg-white/10'} duration-300 flex items-center h-[3.5rem] w-full rounded-lg`} >

      ...
      <div className="bg-white m-5 rounded-2xl z-[1] -mt-16 w-[95%] h-[100]">
        ...
        <div className="flex justify-between">
          ...
          <div className="p-4 mt-4 border-t-2 border-gray-200 rounded-xl shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] bg-white w-1/2 ml-2">
            ...
            {!isEditing && <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nulla neque voluptatum at, accusamus cupiditate quaerat mollitia consequatur dignissimos laudantium facere cum eius velit, quia deserunt harum quis autem fugit ullam.</p>}
            {
